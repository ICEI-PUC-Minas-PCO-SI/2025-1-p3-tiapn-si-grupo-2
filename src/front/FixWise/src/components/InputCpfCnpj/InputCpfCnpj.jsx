...
const InputCpfCnpj = ({ value, onChange, onCnpjData }) => {
  ...
  const handleChange = (e) => {
    ...
    onChange({
      target: {
        name: "cpfCnpj", // ou o nome correto do campo no seu form
        value: inputValue,
      },
    });
  };
      ...
      <div className="flex flex-col w-auto gap-2">
        <div className="relative">
          ...
          <button
            ...
            disabled={isLoading}
            className="absolute right-[1%] top-1/2 -translate-y-1/2 p-2 text-gray-500 hover:text-gray-700 disabled:text-gray-300 cursor-pointer"
          >
            <FaSearch />
          </button>
